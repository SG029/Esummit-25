...
function About() {
  return (
    ...
    >
      ...
      <div className='flex justify-between w-5/6 mt-8 gap-[6vw]'>
        <div className='w-1/2'>
          <img src={aboutleft} alt="About Left" className='w-full h-auto' />
        </div>
        <div
  className='w-1/2 px-10 py-14 rounded-lg gap-10 flex flex-col justify-center border-3 border-[#046C70] text-white'
  style={{
...
>
  <div className='flex justify-between items-center gap-3'>
    <div className='flex justify-between flex-col items-center bg-[#482B00] bg-opacity-50 rounded-xl p-4 gap-1'>
      ...
      <h4 className='width-5/6 text-center font-opensanslight text-[1.5vw] leading-7 '>
        Compete for funding and recognition in our pitch competitions.
      </h4>
    </div>
    <div className='flex justify-between flex-col items-center bg-[#482B00] bg-opacity-50 rounded-xl p-4 gap-1'>
      <h2 className='font-fonseca text-[1.7vw]'>WORKSHOPS</h2>
      <h3 className='width-5/6 text-center font-opensanslight text-[1.5vw] leading-7 '>
